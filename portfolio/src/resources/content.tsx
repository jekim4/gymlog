...
const home: Home = {
  ...
  subline: (
    <>
      I'm {person.firstName}, a {person.role.toLowerCase()} based in Seoul. <br /> I build web apps and learn by shipping things.
    </>
  ),
};
